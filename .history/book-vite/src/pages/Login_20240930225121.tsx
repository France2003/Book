...
function Login({ url }: { url: string }) {
    ...
    const handleLogin = (e: React.FormEvent) => {
        ...
        if (storedUsers) {
            ...
            if (user) {
                ...
                // Remove this timeout if you don't want to redirect after login
                setTimeout(() => {
    ...
    // Additionally, consider adding a link or button for users to navigate to the home page without logging in
