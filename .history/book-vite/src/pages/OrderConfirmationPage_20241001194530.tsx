...
const OrderConfirmation: React.FC = () => {
  ...
  const cancelOrder = () => {
    if (orderInfo) {
      const canceledOrderInfo = { ...orderInfo, canceled: true }; // Thêm trạng thái hủy
      localStorage.setItem('orderInfo', JSON.stringify(canceledOrderInfo));
      alert('Đơn hàng đã bị hủy!');
      // Bạn có thể điều hướng đến trang khác nếu muốn
    }
  };
