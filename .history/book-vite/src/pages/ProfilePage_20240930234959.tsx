...
function UserProfile() {
    ...
    const [avatar, setAvatar] = useState<File | null>(null); // Store the File object
    const [avatarUrl, setAvatarUrl] = useState<string | null>(null); // Store the URL for display
    ...
    const handleFileChange = (info: any) => {
        if (info.file.status === 'done') {
            setAvatar(info.file.originFileObj); // Set the file object
            const url = URL.createObjectURL(info.file.originFileObj);
            setAvatarUrl(url); // Set the URL for displaying the image
        }
    };
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 text-gray-800">
            ...
            <div className="w-full max-w-3xl bg-white rounded-lg shadow-md flex p-8">
                ...
                <div className="w-1/3 flex flex-col items-center justify-center">
                    {avatarUrl ? ( // Use avatarUrl to display the image
                        <img
                            src={avatarUrl}
                            alt="Avatar Preview"
