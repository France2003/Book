...
import { addBook, removeBook, updateBook, addFeaturedBook, addBestSeller } from '../redux/bookSlice';
...
const AdminPage: React.FC = () => {
  ...
  const handleAddFeaturedBook = (book: Book) => {
    dispatch(addFeaturedBook(book));
    message.success('Sách nổi bật đã được thêm!');
  };


  const handleAddBestSeller = (book: Book) => {
    dispatch(addBestSeller(book));
    message.success('Sách bán chạy đã được thêm!');
  };
      ...
      <Tabs defaultActiveKey="1">
        ...
        <TabPane tab="Danh Sách Sách" key="2">
          ...
          <BookListAdmin
            ...
            onAddFeatured={handleAddFeaturedBook}
