              ...
              >
                ...
                {book.discountPercentage && book.discountPercentage > 0 ? (
                  <p className="text-green-600 font-semibold">
                    Giảm giá: {book.discountPercentage}% - Giá sau giảm: 
                    {calculateDiscountedPrice(
                      parseFloat(book.price.toString()), // Chuyển đổi thành số
                      parseFloat(book.discountPercentage.toString()) // Chuyển đổi thành số
                    ).toFixed(2)} VND
                  </p>
                ) : null}
