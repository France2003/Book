              ...
              >
                ...
                {book.discountPercentage && book.discountPercentage > 0 ? (
                  <p className="text-green-600 font-semibold">
                    Giảm giá: {book.discountPercentage}% - Giá sau giảm: {calculateDiscountedPrice(
                      parseFloat(book.price.toString()), // Convert to number
                      parseFloat(book.discountPercentage.toString()) // Convert to number
                    ).toFixed(2)} VND
                  </p>
                ) : null}
