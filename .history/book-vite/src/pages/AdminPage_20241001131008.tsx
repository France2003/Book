...
import { addBook, removeBook, updateBook, toggleFeatured, toggleBestSeller } from '../redux/bookSlice'; // Thêm các action vào đây
...
const AdminPage: React.FC = () => {
  ...
  const handleAddFeatured = (book: Book) => {
    dispatch(toggleFeatured(book.id)); // Cập nhật trạng thái trong Redux
  ...
  const handleRemoveFeatured = (bookId: number) => {
    dispatch(toggleFeatured(bookId)); // Cập nhật trạng thái trong Redux
  ...
  const handleAddBestSeller = (book: Book) => {
    dispatch(toggleBestSeller(book.id)); // Cập nhật trạng thái trong Redux
  ...
  const handleRemoveBestSeller = (bookId: number) => {
    dispatch(toggleBestSeller(bookId)); // Cập nhật trạng thái trong Redux
