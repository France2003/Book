...
function Register({ url }: { url: string }) {
    ...
    // Kiểm tra mật khẩu có hợp lệ không (ít nhất 8 ký tự, bao gồm chữ hoa, chữ thường và số)
    ...
    const handleRegister = (e: React.FormEvent) => {
        ...
        // Nếu không có lỗi, tiến hành lưu người dùng vào localStorage
        const user = {
            name,
            email,
            password,
    ...
    // Toggle hiển thị mật khẩu của ô Password
    const togglePasswordVisibility = () => {
        setShowPassword(!showPassword);
    };

    // Toggle hiển thị mật khẩu của ô Confirm Password
                ...
                <form onSubmit={handleRegister}>
                    ...
                    <div className="mb-4 relative">
                        ...
                        <input
                            ...
                            type={showPassword ? "text" : "password"}  // Hiển thị password nếu showPassword = true
                            id="password"
                    ...
                    <div className="mb-6 relative">
                        ...
                        <input
                            ...
                            type={showConfirmPassword ? "text" : "password"}  // Hiển thị password nếu showConfirmPassword = true
                            id="confirmPassword"
