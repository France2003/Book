...
const AdminPage: React.FC = () => {
  ...
  const handleAddFeatured = (book: Book) => {
    // Thực hiện logic thêm sách vào danh sách nổi bật
  ...
  const handleRemoveFeatured = (bookId: number) => {
    // Thực hiện logic xóa sách khỏi danh sách nổi bật
  ...
  const handleAddBestSeller = (book: Book) => {
    // Thực hiện logic thêm sách vào danh sách bán chạy
  ...
  const handleRemoveBestSeller = (bookId: number) => {
    // Thực hiện logic xóa sách khỏi danh sách bán chạy
