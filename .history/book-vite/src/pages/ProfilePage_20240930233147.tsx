...
function UserProfile() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-800 to-blue-600 text-white">
            <Helmet>
                <meta charSet="utf-8" />
                <title>Hồ Sơ Của Tôi</title>
            </Helmet>
            <div className="w-full max-w-md bg-gray-900 rounded-lg shadow-lg p-8">
                <h2 className="text-4xl font-bold mb-6 text-center">Hồ Sơ Của Tôi</h2>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex space-x-4">
                            <input
                                type="number"
                                className="w-1/3 px-4 py-2 border border-gray-700 rounded-md bg-gray-800 text-white"
                                value={birthDate.day}
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className="block w-full text-sm text-gray-500 border border-gray-700 rounded-md bg-gray-800"
                        />
                    </div>
                    <button
