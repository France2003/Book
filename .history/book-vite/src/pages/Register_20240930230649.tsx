            ...
            <div className="w-full max-w-md bg-gray-800 rounded-lg shadow-md p-8">
                ...
                <form onSubmit={handleRegister}>
                    ...
                    <div className="mb-4 relative">
                        ...
                        <input
                            className={`w-full px-3 py-2 border ${passwordError ? "border-red-600" : "border-gray-600"} rounded-md bg-gray-700 text-white min-h-[48px]`} // Added min-height
                    ...
                    <div className="mb-6 relative">
                        ...
                        <input
                            className={`w-full px-3 py-2 border ${passwordMatch ? "border-gray-600" : "border-red-600"} rounded-md bg-gray-700 text-white min-h-[48px]`} // Added min-height
