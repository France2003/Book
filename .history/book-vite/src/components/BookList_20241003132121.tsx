...
import { Link, useParams, useHistory } from 'react-router-dom'; // Add useHistory
...
const BookList: React.FC = () => {
  ...
  const handleSearch = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Redirect to SearchResults with query
    if (term) {
      history.push(`/search?query=${encodeURIComponent(term)}`);
    } else {
      // Reset filteredBooks if search term is cleared
      filterBooks(selectedGrade, '');
    }
  };
