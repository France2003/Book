...
interface HeaderProps {
  onSearch: (searchTerm: string) => void; // Thêm prop cho hàm tìm kiếm
}
...
const Header: React.FC<HeaderProps> = ({ onSearch }) => {
  ...
  const handleSearch = (value: string) => {
    setSearchTerm(value);
    onSearch(value); // Gọi hàm tìm kiếm truyền từ props
  };
      ...
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="flex-1 mx-4">
          <Search
            ...
            value={searchTerm}
            onSearch={handleSearch} // Sử dụng hàm tìm kiếm ở đây
