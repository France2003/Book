...
const AddBookForm: React.FC<AddBookFormProps> = ({
  ...
  const [isBestSeller, setIsBestSeller] = useState<boolean>(false); // Trạng thái cho Bán chạy
  const [isFeatured, setIsFeatured] = useState<boolean>(false); // Trạng thái cho Nổi bật
