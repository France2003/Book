        ...
        <div className="flex-1 p-6">
          ...
          <div className="flex flex-col mt-10 md:flex-row">
            ...
            <div className="md:ml-6 md:w-1/2">
              ...
              {/* Display discount label if the book is promotional */}
              {book?.isBestSeller && (
              ...
              {relatedBooks.slice(0, 8).map((relatedBook) => (
                <Card
                  ...
                  cover={
                    <div className="relative">
                      ...
                      />
                      {/* Display discount label for promotional related books */}
                ...
                >
                  <Card.Meta
                    ...
                    description={`${relatedBook.price} VND`}
                  />
                  <Button
                    type="primary"
                    block
                    className="mt-4"
                    onClick={() => handleAddRelatedBookToCart(relatedBook)}
                  >
                    Thêm vào giỏ hàng
                  </Button>
                </Card>
