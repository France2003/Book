...
const BookList: React.FC = () => {
  ...
  const handleGradeChange = (value: string | null) => {
    ...
    filterBooks(value || undefined, searchTerm); // Sử dụng từ khóa tìm kiếm hiện tại
  };
  ...
  const handleSearch = (term: string) => {
    ...
    filterBooks(selectedGrade, term); // Lọc sách dựa trên từ khóa tìm kiếm
  };
  ...
  return (
    <div className="flex flex-col md:flex-row">
      <Header onSearch={handleSearch} /> {/* Header với tìm kiếm */}
