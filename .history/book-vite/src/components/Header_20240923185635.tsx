  ...
  return (
    <header className="bg-white border-2 p-4">
      <div className="container mx-auto">
        {/* Logo, User, and Cart in one row */}
        <div className="flex flex-col sm:flex-row items-center justify-between space-x-0 sm:space-x-4">
              ...
              {['H', 'U', 'Y', ' ', 'B', 'O', 'O', 'K', 'S'].map((letter, index) => (
                <span
                  ...
                  style={{
                    ...
                    color: `hsl(${index * 40}, 90%, 60%)`, // Color each letter differently
                  }}
                >
                  {letter}
                </span>
