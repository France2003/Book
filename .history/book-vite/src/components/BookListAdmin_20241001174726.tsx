...
import { removeBestSellerBook, removeFeaturedBook } from '../redux/bookSlice';

// Giao diện props cho BookListAdmin
interface BookListProps {
  ...
  bookId: BookAdminProps[];
}
interface BookAdminProps {
  book: number; // Đảm bảo bookId được định nghĩa trong props
}
                ...
                actions={[
                  ...
                  book.isFeatured ? (
                    <Button
                      ...
                      icon={<StarFilled />}
                      onClick={() => {
                        dispatch(removeFeaturedBook(bookId));
