...
interface BookListProps {
  ...
  onAddFeatured: (book: Book) => void; // Thêm prop
  onRemoveFeatured: (bookId: number) => void; // Thêm prop
  onAddBestSeller: (book: Book) => void; // Thêm prop
  onRemoveBestSeller: (bookId: number) => void; // Thêm prop
}
        ...
        renderItem={(book, index) => (
          <List.Item
            actions={[
              ...
              // Nút thêm sách vào danh sách nổi bật
              book.isFeatured ? (
                <Button
                  key="removeFeatured"
                  type="link"
              ...
              // Nút thêm sách vào danh sách bán chạy
              book.isBestSeller ? (
                <Button
